  ...
  return (
    <div ref={wrapRef} style={{ padding: "2px 8px 0" }}>
      {!open ? (
        ...
        <div style={{ margin: "2px 0", display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", background: darkMode ? "#161b22" : "#f1f5f9", borderRadius: 10, border: `1px solid ${accent}55` }}>
